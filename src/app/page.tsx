...
/**
 * 메인 랜딩 페이지 - 사용자 타입(학생/교수) 선택
 */
export default function HomePage() {
  return (
    <main className="flex w-full flex-1 flex-col justify-center bg-gray-100">
 ...
 * 사용자 타입 선택 카드 컴포넌트
 */
function UserTypeCard({ title, description, icon, href, gradient }: UserTypeCardProps) {
  return (
