...
export async function CreateInterviewEmail(
  studentName: string,
  ...
  const mailOptions = {
    ...
    subject: `${professorName} 교수님, 새로운 면담 예약 신청을 확인해주세요.`,
    text: `${professorName} 교수님, 새로운 면담 요청이 도착했습니다. 아래 링크를 통해 확인해주세요.\n http://localhost:3000`,
    html: `
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        <h2 style="color: #333;">Knock Knock - 새로운 면담 예약 신청</h2>
        <p><strong>${professorName}</strong> 교수님, 새로운 면담 요청이 도착했습니다.</p>
